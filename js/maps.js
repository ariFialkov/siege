...
function buildFortress() {
  ...
  return {
    ...
    botMounts: [new THREE.Vector3(-26, 10.6, 0), new THREE.Vector3(26, 10.6, 0)],
...
function buildGalleon() {
  ...
  return {
    ...
    botMounts: [new THREE.Vector3(-6.6, 7.4, -3), new THREE.Vector3(6.6, 7.4, -3)],
...
function buildBurm() {
  ...
  return {
    ...
    botMounts: [new THREE.Vector3(-22, groundHeight(-22, 2) + 0.5, 2), new THREE.Vector3(22, groundHeight(22, 2) + 0.5, 2)],
...
function buildTemple() {
  ...
  return {
    ...
    botMounts: [new THREE.Vector3(-20, groundHeight(-20, -8) + 0.5, -8), new THREE.Vector3(20, groundHeight(20, -8) + 0.5, -8)],
